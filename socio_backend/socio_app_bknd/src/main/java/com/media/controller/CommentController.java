...
public class CommentController {
	...
	public Comment createCommnet(@RequestBody Comment comment, @RequestHeader("Authorization") String jwt,
	...
	public Comment likeCommnet(@RequestHeader("Authorization") String jwt, @PathVariable Integer commentId)
			throws Exception {
